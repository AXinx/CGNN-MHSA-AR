...
def load_and_save2(filename, dataset_folder, shape,output_folder,dataset):
    temp = np.zeros(shape)
    ...
    with open(path.join(output_folder, dataset + "_" + 'inter_label' + ".pkl"), "wb") as file:
        dump(temp, file)
    return temp
